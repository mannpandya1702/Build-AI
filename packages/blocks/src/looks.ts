...
const ROOFING: Look[] = [
  {
    ...
    typePairing: { display: "Bricolage Grotesque", body: "Source Sans 3" },
    heroVariant: "photo",
  },
  ...
  // look at assign time, so locked/sent demos render exactly as they did.
  {
    ...
    typePairing: { display: "Barlow Condensed", body: "IBM Plex Sans" },
    heroVariant: "split",
  },
  {
    name: "moss-craft",
    ...
    typePairing: { display: "Space Grotesk", body: "Source Sans 3" },
    heroVariant: "bold",
  },
  {
    name: "ember-storm",
    ...
    typePairing: { display: "Alfa Slab One", body: "Source Sans 3" },
    heroVariant: "photo",
  },
  ...
  // looks so the §5d "no two prospects in a metro share a look" rule always has free options.
  {
    ...
    palette: {
      brand: "163 45 30",
      brandInk: "253 246 242",
      ink: "28 18 16",
      paper: "249 243 239",
      paper2: "242 233 228",
    },
    typePairing: { display: "Bricolage Grotesque", body: "Hanken Grotesk" },
    heroVariant: "split",
  },
  {
    name: "ember-forge",
    ...
    palette: {
      brand: "194 65 12",
      brandInk: "255 250 243",
      ink: "25 21 18",
      paper: "250 246 240",
      paper2: "243 236 227",
    },
    typePairing: { display: "Space Grotesk", body: "Chivo" },
    heroVariant: "bold",
  },
  {
    name: "safety-slate",
    ...
    palette: {
      brand: "216 80 10",
      brandInk: "255 251 246",
      ink: "18 24 31",
      paper: "246 248 250",
      paper2: "233 238 243",
    },
    typePairing: { display: "Anton", body: "IBM Plex Sans" },
    heroVariant: "split",
  },
  {
    ...
    palette: {
      brand: "180 83 9",
      brandInk: "253 247 238",
      ink: "26 22 17",
      paper: "251 246 238",
      paper2: "245 237 224",
    },
    typePairing: { display: "Bebas Neue", body: "Source Sans 3" },
    heroVariant: "photo",
  },
  {
    name: "clay-adobe",
    ...
    palette: {
      brand: "168 88 50",
      brandInk: "255 249 242",
      ink: "30 22 18",
      paper: "250 244 235",
      paper2: "244 234 221",
    },
    typePairing: { display: "Outfit", body: "Rubik" },
    heroVariant: "photo",
  },
  {
    ...
    palette: {
      brand: "38 80 110",
      brandInk: "244 248 251",
      ink: "20 26 32",
      paper: "245 247 249",
      paper2: "232 237 241",
    },
    typePairing: { display: "Sora", body: "Manrope" },
    heroVariant: "bold",
  },
  ...
  // widen the template's structural range — "paper" opens LIGHT, which no earlier look could.
  {
    ...
    palette: {
      brand: "166 61 21",
      brandInk: "255 250 244",
      ink: "28 22 18",
      paper: "250 246 240",
      paper2: "243 235 225",
    },
    typePairing: { display: "Bricolage Grotesque", body: "Manrope" },
    heroVariant: "paper",
  },
  {
    name: "limestone-editorial",
    preset: "roofing",
    palette: {
      brand: "154 52 18",
      brandInk: "255 249 243",
      ink: "24 24 27",
      paper: "251 250 247",
      paper2: "241 239 233",
    },
    typePairing: { display: "Sora", body: "Hanken Grotesk" },
    heroVariant: "paper",
  },
  {
    name: "timber-frame",
    ...
    palette: {
      brand: "146 64 14",
      brandInk: "255 250 242",
      ink: "22 18 14",
      paper: "250 247 241",
      paper2: "242 237 228",
    },
    typePairing: { display: "Anton", body: "Rubik" },
    heroVariant: "frame",
  },
  {
    name: "granite-frame",
...
const PLUMBING: Look[] = [
  {
    ...
    typePairing: { display: "Archivo", body: "IBM Plex Sans" },
    heroVariant: "split",
  },
  {
    name: "copper-line",
  ...
  // Skill-grounded + anti-slop-verified (CLAUDE.md §9). Render faithfully once the plumbing template ships.
  {
    ...
    typePairing: { display: "Archivo", body: "Work Sans" },
    heroVariant: "photo",
  },
  {
    name: "brass-gauge",
    ...
    typePairing: { display: "Space Grotesk", body: "DM Sans" },
    heroVariant: "split",
  },
  {
    name: "midnight-ember",
    ...
    palette: {
      brand: "196 68 34",
      brandInk: "255 248 242",
      ink: "3 8 24",
      paper: "244 240 236",
      paper2: "233 227 221",
    },
    typePairing: { display: "Bricolage Grotesque", body: "IBM Plex Sans" },
    heroVariant: "bold",
  },
  {
    name: "signal-azure",
    ...
    palette: {
      brand: "4 92 150",
      brandInk: "240 247 252",
      ink: "12 22 38",
      paper: "244 247 250",
      paper2: "231 237 243",
    },
    typePairing: { display: "Outfit", body: "Work Sans" },
    heroVariant: "photo",
  },
  {
    name: "tidewater-teal",
  ...
  },
  {
    ...
    palette: {
      brand: "188 90 16",
      brandInk: "255 249 240",
      ink: "18 26 42",
      paper: "246 242 236",
      paper2: "236 230 222",
    },
    typePairing: { display: "Archivo", body: "Manrope" },
    heroVariant: "split",
  },
  // 2026-07-11: frame/paper structural variants (21st-sourced, contract-restyled).
  {
    ...
    palette: {
      brand: "30 64 175",
      brandInk: "248 250 255",
      ink: "20 26 40",
      paper: "250 249 245",
      paper2: "239 238 231",
    },
    typePairing: { display: "Sora", body: "Source Sans 3" },
    heroVariant: "paper",
  },
  {
    name: "cast-iron-frame",
    preset: "plumbing",
    palette: {
      brand: "9 88 160",
      brandInk: "245 250 254",
      ink: "12 18 30",
      paper: "246 247 244",
      paper2: "234 236 230",
    },
    typePairing: { display: "Chivo", body: "Work Sans" },
    heroVariant: "frame",
  },
];
...
const HVAC: Look[] = [
  {
    ...
    typePairing: { display: "Space Grotesk", body: "IBM Plex Sans" },
    heroVariant: "split",
  },
  {
    name: "furnace-warm",
    ...
    typePairing: { display: "Archivo", body: "Source Sans 3" },
    heroVariant: "bold",
  },
  // Skill-grounded + anti-slop-verified (CLAUDE.md §9).
  {
    ...
    typePairing: { display: "Sora", body: "Work Sans" },
    heroVariant: "split",
  },
  {
    name: "furnace-copper",
  ...
  // 2026-07-11: paper structural variant (21st-sourced, contract-restyled).
  {
    ...
    typePairing: { display: "Outfit", body: "Manrope" },
    heroVariant: "paper",
  },
];
...
const DENTAL: Look[] = [
  {
    ...
    typePairing: { display: "Fraunces", body: "Newsreader" },
    heroVariant: "split",
  },
  {
    name: "warm-clinic",
    ...
    typePairing: { display: "Playfair Display", body: "Source Sans 3" },
    heroVariant: "photo",
  },
  // Skill-grounded + anti-slop-verified (CLAUDE.md §9).
  {
    ...
    typePairing: { display: "Fraunces", body: "Public Sans" },
    heroVariant: "split",
  },
  {
    name: "rose-editorial",
    ...
    palette: {
      brand: "159 55 74",
      brandInk: "255 251 250",
      ink: "26 22 24",
      paper: "251 249 248",
      paper2: "242 236 236",
    },
    typePairing: { display: "Playfair Display", body: "Work Sans" },
    heroVariant: "photo",
  },
