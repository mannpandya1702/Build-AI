...
export const BLOCKS: readonly BlockDef[] = [
  {
    id: "sticky-call-header",
    label: "Sticky tap-to-call header",
    answers: "how do I call right now",
    persona: "emergency",
    needs: ["phone"],
    structural: false,
    claudeRef: "§5b sticky tap-to-call",
  },
  {
    id: "hero-photo",
    label: "Hero (photo)",
    answers: "is this the right local company for my problem",
    persona: "both",
    needs: ["city", "primaryService"],
    structural: true,
    claudeRef: "§5b location hero + §5c whoa",
  },
  {
    id: "hero-split",
    label: "Hero (split)",
  ...
  },
  {
    id: "stats-strip",
    label: "Stats strip",
    answers: "can I trust them (proof in 3 seconds)",
    persona: "both",
    needs: ["reviewCount|rating|city"],
    structural: false,
    claudeRef: "§5b stats strip",
  },
  {
    id: "niche-need-band",
    label: "Niche-need band",
    answers: "do they handle MY exact moment of need",
    persona: "emergency",
    needs: ["primaryService"],
    structural: false,
    claudeRef: "§5a niche-need moment",
  },
  {
    id: "services-grid",
    label: "Services grid",
    answers: "can I find someone skilled (54% objection)",
    persona: "both",
    needs: ["services"],
    structural: true,
    claudeRef: "§5b services",
  },
  {
    id: "process-steps",
    label: "Process steps (3)",
    answers: "what happens if I call",
    persona: "planner",
    needs: [],
    structural: true,
    claudeRef: "§5b process steps",
  },
  {
    id: "gallery",
    label: "Before/after gallery",
    answers: "is their work actually good",
    persona: "planner",
    needs: ["photos"],
    structural: false,
    claudeRef: "§5b gallery / proof",
  },
  {
    id: "reviews",
    label: "Google reviews (verbatim 4+)",
    answers: "can I trust them (14% objection)",
    persona: "both",
    needs: ["reviews"],
    structural: false,
    claudeRef: "§5b review curation",
  },
  {
    id: "service-map",
    label: "Service-area map",
    answers: "do they cover where I am",
    persona: "both",
    needs: ["mapQuery"],
    structural: true,
    claudeRef: "§5b embedded map + NAP",
  },
  {
    id: "quote-form",
    label: "Quote form (3-5 fields)",
    answers: "let me get a quote without calling",
    persona: "planner",
    needs: ["primaryService"],
    structural: true,
    claudeRef: "§5b short quote form",
  },
  {
    id: "faq",
    label: "FAQ (fact-safe)",
    answers: "the last small questions before I act",
    persona: "planner",
    needs: [],
    structural: true,
    claudeRef: "§5b FAQ fact-safe",
  },
  {
    id: "footer",
    label: "Footer (NAP)",
    answers: "name, address, phone, hours",
    persona: "both",
    needs: ["city"],
    structural: true,
    claudeRef: "§5b NAP",
